...
subtitle: "Comparing the Python development experience with Lisp"
date: "02 Nov 2022"
---

`hey`
This is a lot of text just for a test thought
This is a lot of text just for a test thought
This is a lot of text just for a test thought
This is a lot of text just for a test thought
This is a lot of text just for a test thought

- [Peter Norvig Post](http://norvig.com/java-lisp.html)
- [Original Test Instructions](https://flownet.com/ron/papers/lisp-java/instructions.html)
- [lisp-java paper and info](https://flownet.com/ron/papers/lisp-java/)
...
def main(numbers_file: Path, words_file: Path):
    with open(numbers_file) as numbers:
        for number in numbers:
            print_encodings(number.strip(), words_file)
...
if __name__ == "__main__":
    number_file, words_file = sys.argv[1:]
